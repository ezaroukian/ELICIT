...
with open('genItems.js', 'w') as writefile:
        ...
        writefile.write("var ss1_il = seq('inst', '"+tnames_il[0]+"', sepWith('sep',shuffle('"+"', '".join(names1_il[0:2])+"')), 'toSUS', '" + "', '".join(susNames1i)+"', '"+cnames_il[0]+"', 'middle', '"+tnames_il[1]+"', sepWith('sep',shuffle('"+"', '".join(names1_il[2:4])+"')), 'toSUS', '"+"', '".join(susNames2l)+"', '"+cnames_il[1]+"');\n\n")
        writefile.write("var ss1_li = seq('inst', '"+tnames_li[1]+"', sepWith('sep',shuffle('"+"', '".join(names1_li[2:4])+"')), 'toSUS', '" + "', '".join(susNames1l)+"', '"+cnames_li[1]+"', 'middle', '"+tnames_li[0]+"', sepWith('sep',shuffle('"+"', '".join(names1_li[0:2])+"')), 'toSUS', '"+"', '".join(susNames2i)+"', '"+cnames_li[0]+"');\n\n")  

        writefile.write("var ss2_il = seq('inst', '"+tnames_il[0]+"', sepWith('sep',shuffle('"+"', '".join(names2_il[0:2])+"')), 'toSUS', '" + "', '".join(susNames1i)+"', '"+cnames_il[0]+"', 'middle', '"+tnames_il[1]+"', sepWith('sep',shuffle('"+"', '".join(names2_il[2:4])+"')), 'toSUS', '"+"', '".join(susNames2l)+"', '"+cnames_il[1]+"');\n\n")
        writefile.write("var ss2_li = seq('inst', '"+tnames_li[1]+"', sepWith('sep',shuffle('"+"', '".join(names2_li[2:4])+"')), 'toSUS', '" + "', '".join(susNames1l)+"', '"+cnames_li[1]+"', 'middle', '"+tnames_li[0]+"', sepWith('sep',shuffle('"+"', '".join(names2_li[0:2])+"')), 'toSUS', '"+"', '".join(susNames2i)+"', '"+cnames_li[0]+"');\n\n")

        writefile.write("var ss3_il = seq('inst', '"+tnames_il[0]+"', sepWith('sep',shuffle('"+"', '".join(names3_il[0:2])+"')), 'toSUS', '" + "', '".join(susNames1i)+"', '"+cnames_il[0]+"', 'middle', '"+tnames_il[1]+"', sepWith('sep',shuffle('"+"', '".join(names3_il[2:4])+"')), 'toSUS', '"+"', '".join(susNames2l)+"', '"+cnames_il[1]+"');\n\n")
        writefile.write("var ss3_li = seq('inst', '"+tnames_li[1]+"', sepWith('sep',shuffle('"+"', '".join(names3_li[2:4])+"')), 'toSUS', '" + "', '".join(susNames1l)+"', '"+cnames_li[1]+"', 'middle', '"+tnames_li[0]+"', sepWith('sep',shuffle('"+"', '".join(names3_li[0:2])+"')), 'toSUS', '"+"', '".join(susNames2i)+"', '"+cnames_li[0]+"');\n\n")  

        writefile.write("var ss4_il = seq('inst', '"+tnames_il[0]+"', sepWith('sep',shuffle('"+"', '".join(names4_il[0:2])+"')), 'toSUS', '" + "', '".join(susNames1i)+"', '"+cnames_il[0]+"', 'middle', '"+tnames_il[1]+"', sepWith('sep',shuffle('"+"', '".join(names4_il[2:4])+"')), 'toSUS', '"+"', '".join(susNames2l)+"', '"+cnames_il[1]+"');\n\n")
        writefile.write("var ss4_li = seq('inst', '"+tnames_li[1]+"', sepWith('sep',shuffle('"+"', '".join(names4_li[2:4])+"')), 'toSUS', '" + "', '".join(susNames1l)+"', '"+cnames_li[1]+"', 'middle', '"+tnames_li[0]+"', sepWith('sep',shuffle('"+"', '".join(names4_li[0:2])+"')), 'toSUS', '"+"', '".join(susNames2i)+"', '"+cnames_li[0]+"');\n\n")

        writefile.write("var ss5_il = seq('inst', '"+tnames_il[0]+"', sepWith('sep',shuffle('"+"', '".join(names5_il[0:2])+"')), 'toSUS', '" + "', '".join(susNames1i)+"', '"+cnames_il[0]+"', 'middle', '"+tnames_il[1]+"', sepWith('sep',shuffle('"+"', '".join(names5_il[2:4])+"')), 'toSUS', '"+"', '".join(susNames2l)+"', '"+cnames_il[1]+"');\n\n")
        writefile.write("var ss5_li = seq('inst', '"+tnames_li[1]+"', sepWith('sep',shuffle('"+"', '".join(names5_li[2:4])+"')), 'toSUS', '" + "', '".join(susNames1l)+"', '"+cnames_li[1]+"', 'middle', '"+tnames_li[0]+"', sepWith('sep',shuffle('"+"', '".join(names5_li[0:2])+"')), 'toSUS', '"+"', '".join(susNames2i)+"', '"+cnames_li[0]+"');\n\n")  

        writefile.write("var ss6_il = seq('inst', '"+tnames_il[0]+"', sepWith('sep',shuffle('"+"', '".join(names6_il[0:2])+"')), 'toSUS', '" + "', '".join(susNames1i)+"', '"+cnames_il[0]+"', 'middle', '"+tnames_il[1]+"', sepWith('sep',shuffle('"+"', '".join(names6_il[2:4])+"')), 'toSUS', '"+"', '".join(susNames2l)+"', '"+cnames_il[1]+"');\n\n")
        writefile.write("var ss6_li = seq('inst', '"+tnames_li[1]+"', sepWith('sep',shuffle('"+"', '".join(names6_li[2:4])+"')), 'toSUS', '" + "', '".join(susNames1l)+"', '"+cnames_li[1]+"', 'middle', '"+tnames_li[0]+"', sepWith('sep',shuffle('"+"', '".join(names6_li[0:2])+"')), 'toSUS', '"+"', '".join(susNames2i)+"', '"+cnames_li[0]+"');\n\n")
